        ...
        private string GetPromt(PAGE page, string html)
        {
            switch (page)
            {
             ...
             {{
               ""jobOpening"": {{
                 ""name"": ""Job Title"",
                 ""description"": ""Brief job description. Descriptions should start with a capital letter and end with a period. Descriptions should be clear summory and must be 1 sentence"",
               ...
               ""skills"": [
                 {{
                   ""name"": ""Skill Name. The skill has a maximum of 2 keywords. In a standardized, generally accepted format."",
               ...
               ""workFormats"": [
                 {{
                   ""name"": ""Work Format. The Work Format has a maximum of 2 keywords. In a standardized, generally accepted format. For example, Remote, Office, Full-time, Hybrid ..."",
                   ""description"": ""A description of the work format, such as remote work or office work.""
                 }},
                 {{

Artem Pechenko 🇻🇳, [3/10/2025 3:29 PM]
""name"": ""Work Format. The Work Format has a maximum of 2 keywords. In a standardized, generally accepted format.For example, Remote, Office, Full-time, Hybrid ..."",
                   ""description"": ""A description of the work format, such as full-time employment.""
                 }}
                 ...
               ],
               ""salary"": ""Salary level or compensation information. In the ""USD 1000-2000/month"" format. If it's a fractional number, then bring it to an integer. If there is a ""k"" next to the sum, then you need to multiply the number by 1000 and take ""k"""",
               ""publishDate"": ""Job posting date. In the ""2022-10-03T14:07:11.000Z"" format. If ""Posted: 1 day ago"" is specified, then calculate the date starting from the current date. It may be missing. Сurrent date {DateTime.Now}"",
